    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute left-0 top-0 h-full w-1/3 bg-gradient-to-r from-yellow-400/20 to-transparent"></div>
          <div className="absolute right-0 top-0 h-full w-1/3 bg-gradient-to-l from-blue-400/20 to-transparent"></div>
        </div>
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          <p className="hero-subtitle mx-auto mb-8 max-w-2xl text-xl text-gray-300 md:text-2xl">
          ...
          <div className="hero-cta flex flex-wrap justify-center gap-4">
            <Link
              href="/projects"
              className="group relative overflow-hidden rounded-lg bg-yellow-400 px-8 py-4 font-bold uppercase text-black transition-all hover:scale-105"
            >
              <span className="relative z-10">View Projects</span>
              <div className="absolute inset-0 bg-yellow-300 transition-transform group-hover:translate-x-0 translate-x-full"></div>
            </Link>
            <Link
              href="/contact"
              className="group relative overflow-hidden rounded-lg border-2 border-blue-400 px-8 py-4 font-bold uppercase text-blue-400 transition-all hover:bg-blue-400 hover:text-black"
            >
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className={`stat-number mb-2 text-4xl font-black md:text-5xl ${
                  index % 2 === 0 ? 'text-yellow-400' : 'text-blue-400'
                }`}>
                  {stat.number}
                </div>
      ...
      <section ref={servicesRef} className="py-24">
        <div className="container mx-auto px-4">
          <h2 className="mb-4 text-center text-4xl font-black uppercase tracking-wider md:text-5xl">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {services.map((service, index) => (
              <div
                key={index}
                className="service-card group relative overflow-hidden rounded-lg border border-gray-800 bg-gray-900/50 p-8 transition-all hover:border-yellow-400 hover:bg-gray-900"
              >
                ...
                <div className={`absolute inset-0 opacity-0 transition-opacity group-hover:opacity-10 ${
                  service.color === 'yellow' ? 'bg-yellow-400' :
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden border-y border-gray-800 bg-gradient-to-r from-yellow-400/10 via-blue-400/10 to-orange-400/10 py-24">
        <div className="container relative z-10 mx-auto px-4 text-center">
